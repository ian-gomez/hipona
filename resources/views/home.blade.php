        ...
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <button style="font-size: 13px;" class="btn btn-primary" data-toggle="modal"
                        data-target="#ventanaAgregar">Agregar</button>
                                ...
                                <div class="modal-body">
                                    <form action="{{url('/inserta')}}" method="post" id="form1" class="form">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="ciudadP" id="ciudadP"
                                                placeholder="Ciudad de procedencia" class="form-control" required>
                                        </div> <br>

                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fas fa-university"></i></span>
                                            <input type="text" name="areaCon" id="areaCon"
                                                placeholder="Area de conocimiento" class="form-control " required>
                                        </div> <br>
                                        ...
                                        <hr class="style1">
                                        <button type="submit" id="sub" name="nsubmit"
                    ...
                    <table class="table table-responsive table-hover" id="tablaUsuarios">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <img
                                        src="data:image/png;base64,{{DNS1D::getBarcodePNG(".$Personas->dni.", 'C39')}}"
                                        alt="barcode" /> </td>
                                <td>
                                    {{ Form::open(['route' => ['Listado.edit', $Personas->id], 'method' => 'get']) }} 
                                    <button type="submit" name="modificar"
                                        style="font-size: 13px; background: transparent;" class=" btn btn-outline"> <i
                                ...
                                <td>
                                    ...
                                    <button type="submit" name="eliminar"
                                        style="font-size: 13px; background: transparent;" class=" btn btn-outline"
                                        onclick="alerta();"> <i class="fas fa-trash-alt"></i> </button>
                                    {{ Form::close() }}
                                </td>
                            </tr>
                            @endforeach
