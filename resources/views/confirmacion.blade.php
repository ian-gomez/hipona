    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12" style="text-align: center; background-color:#3B579D;">
                <a> <img class="img" src="img/cabecera1.png"> </a>
            </div>
        </div>
        ...
        <center>
                            ...
                            <td align="center">
                                ...
                                <div style="line-height: 44px;">
                                    <font face="Arial, Helvetica, sans-serif" size="5" color="#57697e"
                                        ...
                                        <span
                                            style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #28252A;">
                            ...
                            <td align="center">
                                <div style="line-height: 24px;">
                                    <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e"
                                        ...
                                        <span
                                            style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #28252A;">
            ...
            <input type="button" class="btn btn-primary" onclick="location.href='http://www.sedessapientiae.edu.ar';"
